...
def at_router2():    
    ...
    util.textCheckPoint(PDUConst.Inbound.IP_ID, "ID: 0x4")
    ...
    util.textCheckPoint(PDUConst.Outbound.IP_ID, "ID: 0x4")
...
def at_pc0():
    ...
    util.textCheckPoint(PDUConst.OSI_EXPLANATION, "1. The packet is a DHCP packet. The DHCP client processes it.\n2. The DHCP client received a DHCP offer packet.\n")
    
    util.clickButton(PDUConst.NEXT_LAYER)
    
    util.textCheckPoint(PDUConst.OSI_OUT_LAYER_7, "Layer 7: \n\nDHCP Frame\nServer: 172.16.10.2, Client: 0.0.0.0")
    util.textCheckPoint(PDUConst.OSI_EXPLANATION, "1. The DHCP client receives an Offer packet, constructs and sends out a Request packet.\n")
    ...
    util.textCheckPoint(PDUConst.Outbound.IP_ID, "ID: 0x2")
    util.textCheckPoint(PDUConst.Outbound.IP_FLAG, "0x0")
    util.textCheckPoint(PDUConst.Outbound.IP_FRAG_OFFSET, "0x0")
