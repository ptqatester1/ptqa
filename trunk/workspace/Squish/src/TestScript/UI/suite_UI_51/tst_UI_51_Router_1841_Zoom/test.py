...
def checkPoint():
    ...
    checkRange(router0.physical.imageObject.maximumSize.width, 944)

    router0.physical.zoomOriginal()
    checkRange(router0.physical.imageObject.maximumSize.width, 472)

    for i in range(2):
        router0.physical.zoomOut()
    checkRange(router0.physical.imageObject.maximumSize.width, 236)
