...
def checkPoint():
    ...
    util.clickOnWorkspace(141, 206)
    util.textCheckPoint(PDUConst.OSI_EXPLANATION, "The ARP process constructs a request for the target IP address.")
    util.clickButton(GoldenSimulationToolbarConst.CAPTURE_FORWARD)
    util.clickButton(GoldenSimulationToolbarConst.BACK)
    util.clickOnWorkspace(141, 206)
    util.textCheckPoint(PDUConst.OSI_EXPLANATION, "The ARP process constructs a request for the target IP address.")