...
def checkPoint():
    ...
    test.compare(findObject(":CAppWindowBase.centralwidget.m_pWorkSpaceWnd.CViewArea_Window1.QStackedWidget1.CWorkspace1.CGeoView1.QGraphicsItem_2").toolTip, "Office Building")
