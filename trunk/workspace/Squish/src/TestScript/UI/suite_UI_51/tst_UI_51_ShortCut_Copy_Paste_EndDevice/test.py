...
def copyPaste_deviceOnWorkspace():
    ...
    PC0.config.interface.wired.duplex('auto')
    PC0.config.interface.wired.portStatus(True)
    PC0.close()
    ...
    Printer0.config.interface.wired.duplex('auto')
    Printer0.config.interface.wired.portStatus(True)  
    Printer0.close()
    ...
    Server0.config.interface.wired.bandwidth('auto')
    Server0.config.interface.wired.duplex('auto')
    Server0.config.interface.wired.portStatus(True)
    ...
    Server0.services.http.httpOn()
    snooze(1)
    Server0.services.selectInterface("TFTP")
    Server0.services.tftp.on()
    Server0.close()
    ...
    CopyPC0.config.settings.gateway("10.1.1.1")
    CopyPC0.config.selectInterface("FastEthernet0")
    CopyPC0.config.interface.wired.check.ip("10.1.1.2")
    snooze(2)
    CopyPC0.config.interface.wired.check.bandwidth('auto', True)
    snooze(2)
    CopyPC0.config.interface.wired.check.duplex('auto', True)
    snooze(2)
    CopyPC0.config.interface.wired.check.portStatus(True)
    CopyPC0.close()
    ...
    snooze(2)
    CopyPrinter0.config.interface.wired.check.bandwidth('auto', True)
    snooze(2)
    CopyPrinter0.config.interface.wired.check.duplex('auto', True)
    snooze(2)
    CopyPrinter0.config.interface.wired.check.portStatus(True)
    CopyPrinter0.close()
    ...
    snooze(2)
    CopyServer0.config.interface.wired.check.portStatus(True)
    CopyServer0.clickServicesTab()
    CopyServer0.services.selectInterface("DHCP")
    snooze(2)
    CopyServer0.services.dhcp.check.off()
    CopyServer0.services.selectInterface("DNS")
    snooze(2)
    CopyServer0.services.dns.check.off()
    CopyServer0.services.selectInterface("HTTP")
    snooze(2)
    CopyServer0.services.http.check.httpOn()
    CopyServer0.services.selectInterface("TFTP")
    snooze(2)
    CopyServer0.services.tftp.check.on()
    CopyServer0.close()
