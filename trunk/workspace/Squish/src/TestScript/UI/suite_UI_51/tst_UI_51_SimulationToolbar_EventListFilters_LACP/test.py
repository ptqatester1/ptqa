...
def switchToSimulation():
    ...
    eventListFilters.checkFilters('LACP', clearFilters=True)
...
def configSwitch0():
    ...
    switch0.cli.setCliText("channel-group 1 mode active")
...
def checkPoint():
    util.clickOnWorkspace(switch0.x + 14, switch0.y + 8)
    util.textCheckPoint(PDUConst.OSI_HEADER_INFO, "LACP Multicast Address")