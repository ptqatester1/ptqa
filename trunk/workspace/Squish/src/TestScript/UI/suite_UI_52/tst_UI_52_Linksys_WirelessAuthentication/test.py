...
def WPA2_PSK(IP):
    ...
    PC_Linksys0.desktop.commandPrompt.setText("ping "+ IP)
    util.speedUpConvergence()
    PC_Linksys0.desktop.commandPrompt.textCheckPoint("Received = 0", 5)
    PC_Linksys0.clickConfigTab()
    PC_Linksys0.config.selectInterface("Wireless0") 
...
def WPA2_PSK_encrypt(IP):   
    ...
    PC_Linksys0.desktop.commandPrompt.setText("ping "+ IP)
    util.speedUpConvergence()
    PC_Linksys0.desktop.commandPrompt.textCheckPoint("Received = 0", 6)
    PC_Linksys0.clickConfigTab()
    PC_Linksys0.config.selectInterface("Wireless0")
    PC_Linksys0.config.interface.wireless.encryption("AES")
...
def WPA(IP):
    ...
    PC_Linksys0.desktop.commandPrompt.setText("ping "+ IP)
    util.speedUpConvergence()
    PC_Linksys0.desktop.commandPrompt.textCheckPoint("Received = 0", 7)
    PC_Linksys0.clickConfigTab()
    PC_Linksys0.config.selectInterface("Wireless0") 
...
def WPA_encrypt(IP):
    ...
    PC_Linksys0.desktop.commandPrompt.setText("ping "+ IP)
    util.speedUpConvergence()
    PC_Linksys0.desktop.commandPrompt.textCheckPoint("Received = 0", 8)
    PC_Linksys0.clickConfigTab()
    PC_Linksys0.config.selectInterface("Wireless0")
    PC_Linksys0.config.interface.wireless.encryption("TKIP")
...
def WPA2(IP):
    ...
    PC_Linksys0.desktop.commandPrompt.setText("ping "+ IP)
    util.speedUpConvergence()
    PC_Linksys0.desktop.commandPrompt.textCheckPoint("Received = 0", 9)
    PC_Linksys0.clickConfigTab()
    PC_Linksys0.config.selectInterface("Wireless0") 
...
def WPA2_encrypt(IP):
    ...
    PC_Linksys0.desktop.commandPrompt.setText("ping "+ IP)
    util.speedUpConvergence()
    PC_Linksys0.desktop.commandPrompt.textCheckPoint("Received = 0", 10)
    PC_Linksys0.clickConfigTab()
    PC_Linksys0.config.selectInterface("Wireless0")
    PC_Linksys0.config.interface.wireless.encryption("TKIP")
