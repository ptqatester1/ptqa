##########################################################
##Author: AbbasH
#@summary: Switch holds instances of cli and menu objects
##########################################################
from API.Android.Device.Switch.Cli import Cli
from API.Android.Device.Switch.Menu import Menu
...
class Switch(DeviceBase):
    ...
    def __init__(self, p_model, p_x, p_y, p_displayName):
        ...
        self.mac_add = ""
        self.model = p_model
        self.deviceType = MainContextMenu.SWITCHES
    ...
    def updateName(self):
        ...
        super(Switch, self).updateName(self.squishName)
